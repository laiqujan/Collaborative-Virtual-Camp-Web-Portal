...
if (isset ( $_POST ['delete'] ) == true) {
	...
	include ("classes/Document.php");
	$user = new Document ();
	$user->deleteRevision( $delname, $RevId, $con );
}
if (isset ( $_POST ['download'] ) == true) {
    ...
    $drname="";
	$query = "select * from documentstate where docId='$docId'";
	...
	<div class="container">
		...
		<div class="panel panel-default"
			...
			<div class="panel-body">
				<h2>Revisions of <span style="text-transform: lowercase;"><?php echo $_GET['docName']?></span> Document</h2>
				<ul class="breadcrumbs">
					
					<li><a href="files.php?teamId=<?php echo $_GET ['teamId'];;?>">Files</a></li>
					<li><a href="files.php?teamId=<?php echo $_GET ['teamId'];?>&dirId=<?php echo $_GET ['dirId']; ?>"><?php echo $drname;?></a></li>
					<li>Revisions</li>
				</ul>
			</div>
		</div>
...
<td>
	...
	data-placement="bottom" title="<?php echo $row['des']; ?>">
	</p>	
...
<td><a 
href="editDocument.php?id=<?php echo $row['location']; ?>&teamId=<?php echo $rid;?>&dirId=<?php echo $row['dirId'];?>&dirName=<?php echo $drname;?>&docId=<?php echo $row['docId'];?>
...
<td>
									...
									<button type="button" class="btn btn-link" data-toggle="modal" style="margin-top:-5px;"
										...
										value="<?php echo $row['location']."+".$row['RevID']."+".$row['docId'];?>"
...
<td>
									<button type="submit" class="btn btn-link" id="delete" style="margin-top:-5px;"
										name="delete"
										value="<?php echo $row['location']."+".$row['RevID'];?>"
