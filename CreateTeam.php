...
if (isset ( $_POST ['create'] ) == true) {
	...
	$team = new Team ();
	if ($team->createTeam ( $id, $name, $category, $message, $con )) {
		$errTyp = "success";
		$errMSG = "Successfully Team Created, Invite People from Dashboard";
	} else {
		$errTyp = "danger";
		$errMSG = "Team Name Not Available Please Select Another one..!!";
	}
}
			...
			<div class="container">
				<div class="row">
					<div class="col-md-8">
						...
						<!-- Start Contact Form -->
						<form role="form" name="createTeam" class="contact-form"
							id="contact-form" method="post" onSubmit="return validateTeam();">
												                    <?php
																																if (isset ( $errMSG )) {
              ...
              <div class="col-sm-12">
							...
							<div class="col-sm-12">
								<div class="form-group">
									...
									<div class="controls">
										<input type="text" placeholder="i.e Education" name="category">
									</div>
								</div>
							</div>
							<div class="col-sm-12">
								<div class="form-group">
									...
									<div class="controls">
										<textarea rows="5" placeholder="Goal" name="message"></textarea>
									</div>
								</div>
							</div>
							<div class="col-sm-12">
								<button type="submit" id="submit" name="create"
									class="btn-system btn-large">Create</button>
